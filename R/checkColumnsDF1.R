#'
#' @title Checks whether columns in a dataframe are the same and of typ 'numerical' or 'integer'
#' @description This function checks a data frame and its columns which should be the same and of typ 'numerical' or 'integer'
...
checkColumnsDF1 <- function(df.name, datasources){
